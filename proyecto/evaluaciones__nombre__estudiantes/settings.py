...
SECRET_KEY = 'django-insecure-y9p5pv%)i&#0fq0pkp-ou2o@jb)6)pv&ic@jqz#!7kqoj^rfm_'
...
ALLOWED_HOSTS = [
    "127.0.0.1",
    "localhost",
    "autenticacion-django.delganicof29.workers.dev",
    ".trycloudflare.com",
]

CSRF_TRUSTED_ORIGINS = [
    "https://autenticacion-django.delganicof29.workers.dev",
